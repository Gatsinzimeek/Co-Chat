...
const ConversationBox: React.FC<ConversationBoxProps> = ({data,selected}) => {
  ...
  return (
    <div onClick={handleClick} className={clsx(`w-full relative flex items-center space-x-3 hover:bg-neutral-100 rounded-lg transition cursor-pointer p-2 ${selected ? 'bg-neutral-100': 'bg-white'}`)}>
